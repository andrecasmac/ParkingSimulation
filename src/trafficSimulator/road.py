...
class Road:
    ...
    def update(self, dt):
        ...
        if n > 0:
            # Check road type and see if the x position is less than the length of the parking box
            if (self.tipo == 0 or (self.tipo == 1 and self.vehicles[0].x < self.length-3.5)):
